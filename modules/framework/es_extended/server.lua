...
Framework.GetIsFrameworkAdmin = function(src)
    ...
    if group == 'admin' or group == 'superadmin' or group == 'owner' or IsPlayerAceAllowed(src, 'command') then return true end
    return false
end
...
Framework.GetVehicleOwner = function(plate)
    ...
    if result and result[1] then return result[1].owner end
    return nil
end
